...
class CompilerRuntime
{
     ...
     */
    public function __construct($dir = null, \WSAL_Vendor\JmesPath\Parser $parser = null)
    {
        $this->parser = $parser ?: new \WSAL_Vendor\JmesPath\Parser();
        $this->compiler = new \WSAL_Vendor\JmesPath\TreeCompiler();
        ...
        $this->interpreter = new \WSAL_Vendor\JmesPath\TreeInterpreter();
    }
    /**
