...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \WSAL_Vendor\JmesPath\Lexer();
        $this->parser = new \WSAL_Vendor\JmesPath\Parser($this->lexer);
    }
    public function __invoke($expression, $data)
    {
        if ($this->runtime instanceof \WSAL_Vendor\JmesPath\CompilerRuntime) {
    ...
    {
        $lexer = new \WSAL_Vendor\JmesPath\Lexer();
    ...
    {
        $parser = new \WSAL_Vendor\JmesPath\Parser();
