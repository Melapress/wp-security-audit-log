...
class AstRuntime
{
    ...
    public function __construct(\WSAL_Vendor\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \WSAL_Vendor\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \WSAL_Vendor\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \WSAL_Vendor\JmesPath\Parser();
    }
    /**
