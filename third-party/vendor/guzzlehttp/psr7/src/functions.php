 ...
 */
function str(\WSAL_Vendor\Psr\Http\Message\MessageInterface $message)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
 ...
 */
function modify_request(\WSAL_Vendor\Psr\Http\Message\RequestInterface $request, array $changes)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
 ...
 */
function rewind_body(\WSAL_Vendor\Psr\Http\Message\MessageInterface $message)
{
    \WSAL_Vendor\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
 ...
 */
function copy_to_string(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream, $maxLen = -1)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
 ...
 */
function copy_to_stream(\WSAL_Vendor\Psr\Http\Message\StreamInterface $source, \WSAL_Vendor\Psr\Http\Message\StreamInterface $dest, $maxLen = -1)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
 ...
 */
function hash(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream, $algo, $rawOutput = \false)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
 ...
 */
function readline(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream, $maxLength = null)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\WSAL_Vendor\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
