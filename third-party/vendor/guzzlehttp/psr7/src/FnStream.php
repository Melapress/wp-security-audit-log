 ...
 * @final
 */
class FnStream implements \WSAL_Vendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
