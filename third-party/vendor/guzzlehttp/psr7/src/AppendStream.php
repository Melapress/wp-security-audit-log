 ...
 * @final
 */
class AppendStream implements \WSAL_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \WSAL_Vendor\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
