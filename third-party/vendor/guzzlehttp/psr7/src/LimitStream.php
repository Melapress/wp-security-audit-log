 ...
 * @final
 */
class LimitStream implements \WSAL_Vendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\WSAL_Vendor\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
