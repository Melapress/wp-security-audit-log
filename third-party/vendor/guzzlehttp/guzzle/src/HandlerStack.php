...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \WSAL_Vendor\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\WSAL_Vendor\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\WSAL_Vendor\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\WSAL_Vendor\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\WSAL_Vendor\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
     ...
     */
    public function __invoke(\WSAL_Vendor\Psr\Http\Message\RequestInterface $request, array $options)
    {
