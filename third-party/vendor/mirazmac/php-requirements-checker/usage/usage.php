...
$checker->requirePhpVersion('>=5.6')->requirePhpExtensions(['ffmpeg', 'mbstring'])->requireFunctions(['random_bytes'])->requireFile('../composer.json', \WSAL_Vendor\MirazMac\Requirements\Checker::CHECK_FILE_EXISTS)->requireDirectory('../src', \WSAL_Vendor\MirazMac\Requirements\Checker::CHECK_IS_READABLE)->requireIniValues(['allow_url_fopen' => \true, 'short_open_tag' => \true, 'memory_limit' => '>=64M']);
