...
abstract class Version
{
     ...
     */
    protected function exception(\WSAL_Vendor\Twilio\Http\Response $response, string $header) : \WSAL_Vendor\Twilio\Exceptions\TwilioException
    {
        ...
        if (\is_array($content)) {
            ...
            return new \WSAL_Vendor\Twilio\Exceptions\RestException($message, $code, $response->getStatusCode(), $moreInfo, $details);
        }
        return new \WSAL_Vendor\Twilio\Exceptions\RestException($message, $response->getStatusCode(), $response->getStatusCode());
    }
    /**
    ...
    public function readLimits(int $limit = null, int $pageSize = null) : array
    {
        ...
        return ['limit' => $limit ?: \WSAL_Vendor\Twilio\Values::NONE, 'pageSize' => $pageSize ?: \WSAL_Vendor\Twilio\Values::NONE, 'pageLimit' => \WSAL_Vendor\Twilio\Values::NONE];
    }
    public function page(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \WSAL_Vendor\Twilio\Http\Response
    {
        return $this->request($method, $uri, $params, $data, $headers, $username, $password, $timeout);
    }
    public function stream(\WSAL_Vendor\Twilio\Page $page, $limit = null, $pageLimit = null) : \WSAL_Vendor\Twilio\Stream
    {
        return new \WSAL_Vendor\Twilio\Stream($page, $limit, $pageLimit);
    }
    /**
     * @throws TwilioException
     */
    ...
    public function getDomain() : \WSAL_Vendor\Twilio\Domain
    {
        return $this->domain;
    }
