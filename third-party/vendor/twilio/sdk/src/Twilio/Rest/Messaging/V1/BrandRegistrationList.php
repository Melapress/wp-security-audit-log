 ...
 */
class BrandRegistrationList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Messaging\V1\BrandRegistrationPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Messaging\V1\BrandRegistrationPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return BrandRegistrationPage Page of BrandRegistrationInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Messaging\V1\BrandRegistrationPage
    {
     ...
     */
    public function create(string $customerProfileBundleSid, string $a2PProfileBundleSid) : \WSAL_Vendor\Twilio\Rest\Messaging\V1\BrandRegistrationInstance
    {
        $data = \WSAL_Vendor\Twilio\Values::of(['CustomerProfileBundleSid' => $customerProfileBundleSid, 'A2PProfileBundleSid' => $a2PProfileBundleSid]);
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Messaging\V1\BrandRegistrationContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Messaging\V1\BrandRegistrationContext($this->version, $sid);
    }
    /**
