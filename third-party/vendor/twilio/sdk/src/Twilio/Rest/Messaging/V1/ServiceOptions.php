...
abstract class ServiceOptions
{
     ...
     */
    public static function create(string $inboundRequestUrl = \WSAL_Vendor\Twilio\Values::NONE, string $inboundMethod = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, bool $stickySender = \WSAL_Vendor\Twilio\Values::NONE, bool $mmsConverter = \WSAL_Vendor\Twilio\Values::NONE, bool $smartEncoding = \WSAL_Vendor\Twilio\Values::NONE, string $scanMessageContent = \WSAL_Vendor\Twilio\Values::NONE, bool $fallbackToLongCode = \WSAL_Vendor\Twilio\Values::NONE, bool $areaCodeGeomatch = \WSAL_Vendor\Twilio\Values::NONE, int $validityPeriod = \WSAL_Vendor\Twilio\Values::NONE, bool $synchronousValidation = \WSAL_Vendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Messaging\V1\CreateServiceOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Messaging\V1\CreateServiceOptions($inboundRequestUrl, $inboundMethod, $fallbackUrl, $fallbackMethod, $statusCallback, $stickySender, $mmsConverter, $smartEncoding, $scanMessageContent, $fallbackToLongCode, $areaCodeGeomatch, $validityPeriod, $synchronousValidation, $useInboundWebhookOnNumber);
    }
    /**
     ...
     */
    public static function update(string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $inboundRequestUrl = \WSAL_Vendor\Twilio\Values::NONE, string $inboundMethod = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, bool $stickySender = \WSAL_Vendor\Twilio\Values::NONE, bool $mmsConverter = \WSAL_Vendor\Twilio\Values::NONE, bool $smartEncoding = \WSAL_Vendor\Twilio\Values::NONE, string $scanMessageContent = \WSAL_Vendor\Twilio\Values::NONE, bool $fallbackToLongCode = \WSAL_Vendor\Twilio\Values::NONE, bool $areaCodeGeomatch = \WSAL_Vendor\Twilio\Values::NONE, int $validityPeriod = \WSAL_Vendor\Twilio\Values::NONE, bool $synchronousValidation = \WSAL_Vendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Messaging\V1\UpdateServiceOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Messaging\V1\UpdateServiceOptions($friendlyName, $inboundRequestUrl, $inboundMethod, $fallbackUrl, $fallbackMethod, $statusCallback, $stickySender, $mmsConverter, $smartEncoding, $scanMessageContent, $fallbackToLongCode, $areaCodeGeomatch, $validityPeriod, $synchronousValidation, $useInboundWebhookOnNumber);
    }
}
class CreateServiceOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $inboundRequestUrl The URL we call using inbound_method when a
     *                                  message is received by any phone number or
     ...
     *                                        received.
     */
    public function __construct(string $inboundRequestUrl = \WSAL_Vendor\Twilio\Values::NONE, string $inboundMethod = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, bool $stickySender = \WSAL_Vendor\Twilio\Values::NONE, bool $mmsConverter = \WSAL_Vendor\Twilio\Values::NONE, bool $smartEncoding = \WSAL_Vendor\Twilio\Values::NONE, string $scanMessageContent = \WSAL_Vendor\Twilio\Values::NONE, bool $fallbackToLongCode = \WSAL_Vendor\Twilio\Values::NONE, bool $areaCodeGeomatch = \WSAL_Vendor\Twilio\Values::NONE, int $validityPeriod = \WSAL_Vendor\Twilio\Values::NONE, bool $synchronousValidation = \WSAL_Vendor\Twilio\Values::NONE, bool $useInboundWebhookOnNumber = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class UpdateServiceOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $friendlyName A string to describe the resource
     * @param string $inboundRequestUrl The URL we call using inbound_method when a
