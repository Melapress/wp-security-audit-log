 ...
 * @property string $url
 */
class PhoneNumberInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \WSAL_Vendor\Twilio\Rest\Messaging\V1\Service\PhoneNumberContext
    {
        if (!$this->context) {
            $this->context = new \WSAL_Vendor\Twilio\Rest\Messaging\V1\Service\PhoneNumberContext($this->version, $this->solution['serviceSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
