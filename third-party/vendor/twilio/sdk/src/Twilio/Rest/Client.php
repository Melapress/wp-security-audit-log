...
class Client
{
     ...
     */
    public function __construct(string $username = null, string $password = null, string $accountSid = null, string $region = null, \WSAL_Vendor\Twilio\Http\Client $httpClient = null, array $environment = null)
    {
        ...
        if (!$this->username || !$this->password) {
            throw new \WSAL_Vendor\Twilio\Exceptions\ConfigurationException('Credentials are required to create a Client');
        }
        $this->accountSid = $accountSid ?: $this->username;
        if ($httpClient) {
            $this->httpClient = $httpClient;
        } else {
            $this->httpClient = new \WSAL_Vendor\Twilio\Http\CurlClient();
        }
    }
    /**
    ...
    public function request(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \WSAL_Vendor\Twilio\Http\Response
    {
        ...
        $headers['User-Agent'] = 'twilio-php/' . \WSAL_Vendor\Twilio\VersionInfo::string() . ' (PHP ' . \PHP_VERSION . ')';
    ...
    public function buildUri(string $uri) : string
    {
        ...
        return \WSAL_Vendor\Twilio\Security\RequestValidator::unparse_url($parsedUrl);
    }
    /**
     ...
     */
    public function getHttpClient() : \WSAL_Vendor\Twilio\Http\Client
    {
     ...
     */
    public function setHttpClient(\WSAL_Vendor\Twilio\Http\Client $httpClient) : void
    {
        $this->httpClient = $httpClient;
    }
    /**
     ...
     */
    protected function getAccounts() : \WSAL_Vendor\Twilio\Rest\Accounts
    {
        if (!$this->_accounts) {
            $this->_accounts = new \WSAL_Vendor\Twilio\Rest\Accounts($this);
        }
     ...
     */
    protected function getApi() : \WSAL_Vendor\Twilio\Rest\Api
    {
        if (!$this->_api) {
            $this->_api = new \WSAL_Vendor\Twilio\Rest\Api($this);
        }
        return $this->_api;
    }
    /**
     ...
     */
    protected function getAutopilot() : \WSAL_Vendor\Twilio\Rest\Autopilot
    {
        if (!$this->_autopilot) {
            $this->_autopilot = new \WSAL_Vendor\Twilio\Rest\Autopilot($this);
        }
     ...
     */
    protected function getChat() : \WSAL_Vendor\Twilio\Rest\Chat
    {
        if (!$this->_chat) {
            $this->_chat = new \WSAL_Vendor\Twilio\Rest\Chat($this);
        }
        return $this->_chat;
    }
    /**
     ...
     */
    protected function getConversations() : \WSAL_Vendor\Twilio\Rest\Conversations
    {
        if (!$this->_conversations) {
            $this->_conversations = new \WSAL_Vendor\Twilio\Rest\Conversations($this);
        }
     ...
     */
    protected function getEvents() : \WSAL_Vendor\Twilio\Rest\Events
    {
        if (!$this->_events) {
            $this->_events = new \WSAL_Vendor\Twilio\Rest\Events($this);
        }
        return $this->_events;
    }
    /**
     ...
     */
    protected function getFax() : \WSAL_Vendor\Twilio\Rest\Fax
    {
        if (!$this->_fax) {
            $this->_fax = new \WSAL_Vendor\Twilio\Rest\Fax($this);
        }
        return $this->_fax;
    }
    /**
     ...
     */
    protected function getFlexApi() : \WSAL_Vendor\Twilio\Rest\FlexApi
    {
        if (!$this->_flexApi) {
            $this->_flexApi = new \WSAL_Vendor\Twilio\Rest\FlexApi($this);
        }
     ...
     */
    protected function getFrontlineApi() : \WSAL_Vendor\Twilio\Rest\FrontlineApi
    {
        if (!$this->_frontlineApi) {
            $this->_frontlineApi = new \WSAL_Vendor\Twilio\Rest\FrontlineApi($this);
        }
     ...
     */
    protected function getInsights() : \WSAL_Vendor\Twilio\Rest\Insights
    {
        if (!$this->_insights) {
            $this->_insights = new \WSAL_Vendor\Twilio\Rest\Insights($this);
        }
     ...
     */
    protected function getIpMessaging() : \WSAL_Vendor\Twilio\Rest\IpMessaging
    {
        if (!$this->_ipMessaging) {
            $this->_ipMessaging = new \WSAL_Vendor\Twilio\Rest\IpMessaging($this);
        }
     ...
     */
    protected function getLookups() : \WSAL_Vendor\Twilio\Rest\Lookups
    {
        if (!$this->_lookups) {
            $this->_lookups = new \WSAL_Vendor\Twilio\Rest\Lookups($this);
        }
     ...
     */
    protected function getMessaging() : \WSAL_Vendor\Twilio\Rest\Messaging
    {
        if (!$this->_messaging) {
            $this->_messaging = new \WSAL_Vendor\Twilio\Rest\Messaging($this);
        }
     ...
     */
    protected function getMonitor() : \WSAL_Vendor\Twilio\Rest\Monitor
    {
        if (!$this->_monitor) {
            $this->_monitor = new \WSAL_Vendor\Twilio\Rest\Monitor($this);
        }
     ...
     */
    protected function getNotify() : \WSAL_Vendor\Twilio\Rest\Notify
    {
        if (!$this->_notify) {
            $this->_notify = new \WSAL_Vendor\Twilio\Rest\Notify($this);
        }
        return $this->_notify;
    }
    /**
     ...
     */
    protected function getNumbers() : \WSAL_Vendor\Twilio\Rest\Numbers
    {
        if (!$this->_numbers) {
            $this->_numbers = new \WSAL_Vendor\Twilio\Rest\Numbers($this);
        }
     ...
     */
    protected function getPreview() : \WSAL_Vendor\Twilio\Rest\Preview
    {
        if (!$this->_preview) {
            $this->_preview = new \WSAL_Vendor\Twilio\Rest\Preview($this);
        }
     ...
     */
    protected function getPricing() : \WSAL_Vendor\Twilio\Rest\Pricing
    {
        if (!$this->_pricing) {
            $this->_pricing = new \WSAL_Vendor\Twilio\Rest\Pricing($this);
        }
     ...
     */
    protected function getProxy() : \WSAL_Vendor\Twilio\Rest\Proxy
    {
        if (!$this->_proxy) {
            $this->_proxy = new \WSAL_Vendor\Twilio\Rest\Proxy($this);
        }
        return $this->_proxy;
    }
    /**
     ...
     */
    protected function getServerless() : \WSAL_Vendor\Twilio\Rest\Serverless
    {
        if (!$this->_serverless) {
            $this->_serverless = new \WSAL_Vendor\Twilio\Rest\Serverless($this);
        }
     ...
     */
    protected function getStudio() : \WSAL_Vendor\Twilio\Rest\Studio
    {
        if (!$this->_studio) {
            $this->_studio = new \WSAL_Vendor\Twilio\Rest\Studio($this);
        }
        return $this->_studio;
    }
    /**
     ...
     */
    protected function getSync() : \WSAL_Vendor\Twilio\Rest\Sync
    {
        if (!$this->_sync) {
            $this->_sync = new \WSAL_Vendor\Twilio\Rest\Sync($this);
        }
        return $this->_sync;
    }
    /**
     ...
     */
    protected function getTaskrouter() : \WSAL_Vendor\Twilio\Rest\Taskrouter
    {
        if (!$this->_taskrouter) {
            $this->_taskrouter = new \WSAL_Vendor\Twilio\Rest\Taskrouter($this);
        }
     ...
     */
    protected function getTrunking() : \WSAL_Vendor\Twilio\Rest\Trunking
    {
        if (!$this->_trunking) {
            $this->_trunking = new \WSAL_Vendor\Twilio\Rest\Trunking($this);
        }
     ...
     */
    protected function getTrusthub() : \WSAL_Vendor\Twilio\Rest\Trusthub
    {
        if (!$this->_trusthub) {
            $this->_trusthub = new \WSAL_Vendor\Twilio\Rest\Trusthub($this);
        }
     ...
     */
    protected function getVerify() : \WSAL_Vendor\Twilio\Rest\Verify
    {
        if (!$this->_verify) {
            $this->_verify = new \WSAL_Vendor\Twilio\Rest\Verify($this);
        }
        return $this->_verify;
    }
    /**
     ...
     */
    protected function getVideo() : \WSAL_Vendor\Twilio\Rest\Video
    {
        if (!$this->_video) {
            $this->_video = new \WSAL_Vendor\Twilio\Rest\Video($this);
        }
        return $this->_video;
    }
    /**
     ...
     */
    protected function getVoice() : \WSAL_Vendor\Twilio\Rest\Voice
    {
        if (!$this->_voice) {
            $this->_voice = new \WSAL_Vendor\Twilio\Rest\Voice($this);
        }
        return $this->_voice;
    }
    /**
     ...
     */
    protected function getWireless() : \WSAL_Vendor\Twilio\Rest\Wireless
    {
        if (!$this->_wireless) {
            $this->_wireless = new \WSAL_Vendor\Twilio\Rest\Wireless($this);
        }
     ...
     */
    protected function getSupersim() : \WSAL_Vendor\Twilio\Rest\Supersim
    {
        if (!$this->_supersim) {
            $this->_supersim = new \WSAL_Vendor\Twilio\Rest\Supersim($this);
        }
     ...
     */
    protected function getBulkexports() : \WSAL_Vendor\Twilio\Rest\Bulkexports
    {
        if (!$this->_bulkexports) {
            $this->_bulkexports = new \WSAL_Vendor\Twilio\Rest\Bulkexports($this);
        }
    ...
    public function __get(string $name)
    {
        ...
        throw new \WSAL_Vendor\Twilio\Exceptions\TwilioException('Unknown domain ' . $name);
    }
    /**
     ...
     */
    public function validateSslCertificate(\WSAL_Vendor\Twilio\Http\CurlClient $client) : void
    {
        $response = $client->request('GET', 'https://api.twilio.com:8443');
        if ($response->getStatusCode() < 200 || $response->getStatusCode() > 300) {
            throw new \WSAL_Vendor\Twilio\Exceptions\TwilioException('Failed to validate SSL certificate');
        }
    }
}
