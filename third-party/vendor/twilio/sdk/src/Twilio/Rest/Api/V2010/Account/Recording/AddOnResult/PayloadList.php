...
class PayloadList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     *                               payload belongs
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, string $accountSid, string $referenceSid, string $addOnResultSid)
    {
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return PayloadPage Page of PayloadInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadPage
    {
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResult\PayloadContext($this->version, $this->solution['accountSid'], $this->solution['referenceSid'], $this->solution['addOnResultSid'], $sid);
    }
    /**
