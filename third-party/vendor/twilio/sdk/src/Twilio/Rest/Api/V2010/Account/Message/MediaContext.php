...
class MediaContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, $accountSid, $messageSid, $sid)
    {
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Message\MediaInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Message\MediaInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['messageSid'], $this->solution['sid']);
    }
    /**
