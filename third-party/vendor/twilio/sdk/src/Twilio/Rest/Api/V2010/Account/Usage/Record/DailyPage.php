...
class DailyPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\DailyInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\DailyInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
