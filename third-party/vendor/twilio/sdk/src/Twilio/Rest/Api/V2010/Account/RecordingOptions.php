...
abstract class RecordingOptions
{
     ...
     */
    public static function read(string $dateCreatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreated = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreatedAfter = \WSAL_Vendor\Twilio\Values::NONE, string $callSid = \WSAL_Vendor\Twilio\Values::NONE, string $conferenceSid = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadRecordingOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadRecordingOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter, $callSid, $conferenceSid);
    }
}
class ReadRecordingOptions extends \WSAL_Vendor\Twilio\Options
{
     ...
     * @param string $conferenceSid Read by unique Conference SID for the recording
     */
    public function __construct(string $dateCreatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreated = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreatedAfter = \WSAL_Vendor\Twilio\Values::NONE, string $callSid = \WSAL_Vendor\Twilio\Values::NONE, string $conferenceSid = \WSAL_Vendor\Twilio\Values::NONE)
    {
