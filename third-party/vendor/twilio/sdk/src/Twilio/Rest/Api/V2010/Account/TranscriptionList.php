...
class TranscriptionList extends \WSAL_Vendor\Twilio\ListResource
{
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return TranscriptionPage Page of TranscriptionInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionPage
    {
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
