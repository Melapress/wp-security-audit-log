...
class SigningKeyPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
