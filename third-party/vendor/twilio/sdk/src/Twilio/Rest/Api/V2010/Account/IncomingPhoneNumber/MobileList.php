...
class MobileList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\MobilePage
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\MobilePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return MobilePage Page of MobileInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\MobilePage
    {
     ...
     */
    public function create(string $phoneNumber, array $options = []) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\MobileInstance
    {
        $options = new \WSAL_Vendor\Twilio\Values($options);
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\MobileInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
