...
class AuthCallsIpAccessControlListMappingContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    /**
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\Domain\AuthTypes\AuthTypeCalls\AuthCallsIpAccessControlListMappingInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\Domain\AuthTypes\AuthTypeCalls\AuthCallsIpAccessControlListMappingInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['domainSid'], $this->solution['sid']);
    }
    /**
