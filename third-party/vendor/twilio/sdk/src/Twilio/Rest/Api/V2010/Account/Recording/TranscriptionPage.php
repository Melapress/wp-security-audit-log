...
class TranscriptionPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['recordingSid']);
    }
    /**
