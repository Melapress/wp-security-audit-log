...
class NationalPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\NationalInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\NationalInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['countryCode']);
    }
    /**
