...
class KeyPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\KeyInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\KeyInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
