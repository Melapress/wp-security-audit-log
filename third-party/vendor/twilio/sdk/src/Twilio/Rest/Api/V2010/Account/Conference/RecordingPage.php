...
class RecordingPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Conference\RecordingInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Conference\RecordingInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['conferenceSid']);
    }
    /**
