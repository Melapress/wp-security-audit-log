...
class AuthorizedConnectAppList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return AuthorizedConnectAppPage Page of AuthorizedConnectAppInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppPage
    {
     ...
     */
    public function getContext(string $connectAppSid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppContext($this->version, $this->solution['accountSid'], $connectAppSid);
    }
    /**
