 ...
 */
class ValidationRequestInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\WSAL_Vendor\Twilio\Version $version, array $payload, string $accountSid)
    {
        ...
        $this->properties = ['accountSid' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'account_sid'), 'callSid' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'call_sid'), 'friendlyName' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'friendly_name'), 'phoneNumber' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'phone_number'), 'validationCode' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'validation_code')];
