...
class TranscriptionContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, $accountSid, $recordingSid, $sid)
    {
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\TranscriptionInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['recordingSid'], $this->solution['sid']);
    }
    /**
