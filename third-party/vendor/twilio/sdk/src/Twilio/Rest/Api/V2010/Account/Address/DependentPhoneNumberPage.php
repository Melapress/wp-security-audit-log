...
class DependentPhoneNumberPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Address\DependentPhoneNumberInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Address\DependentPhoneNumberInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['addressSid']);
    }
    /**
