...
class QueueList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueuePage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueuePage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return QueuePage Page of QueueInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueuePage
    {
     ...
     */
    public function create(string $friendlyName, array $options = []) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueueInstance
    {
        $options = new \WSAL_Vendor\Twilio\Values($options);
        $data = \WSAL_Vendor\Twilio\Values::of(['FriendlyName' => $friendlyName, 'MaxSize' => $options['maxSize']]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueueInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueueContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueueContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
