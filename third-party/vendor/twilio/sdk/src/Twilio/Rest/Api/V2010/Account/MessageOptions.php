...
abstract class MessageOptions
{
     ...
     */
    public static function create(string $from = \WSAL_Vendor\Twilio\Values::NONE, string $messagingServiceSid = \WSAL_Vendor\Twilio\Values::NONE, string $body = \WSAL_Vendor\Twilio\Values::NONE, array $mediaUrl = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $applicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $maxPrice = \WSAL_Vendor\Twilio\Values::NONE, bool $provideFeedback = \WSAL_Vendor\Twilio\Values::NONE, int $attempt = \WSAL_Vendor\Twilio\Values::NONE, int $validityPeriod = \WSAL_Vendor\Twilio\Values::NONE, bool $forceDelivery = \WSAL_Vendor\Twilio\Values::NONE, string $contentRetention = \WSAL_Vendor\Twilio\Values::NONE, string $addressRetention = \WSAL_Vendor\Twilio\Values::NONE, bool $smartEncoded = \WSAL_Vendor\Twilio\Values::NONE, array $persistentAction = \WSAL_Vendor\Twilio\Values::ARRAY_NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CreateMessageOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CreateMessageOptions($from, $messagingServiceSid, $body, $mediaUrl, $statusCallback, $applicationSid, $maxPrice, $provideFeedback, $attempt, $validityPeriod, $forceDelivery, $contentRetention, $addressRetention, $smartEncoded, $persistentAction);
    }
    /**
     ...
     */
    public static function read(string $to = \WSAL_Vendor\Twilio\Values::NONE, string $from = \WSAL_Vendor\Twilio\Values::NONE, string $dateSentBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateSent = \WSAL_Vendor\Twilio\Values::NONE, string $dateSentAfter = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadMessageOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadMessageOptions($to, $from, $dateSentBefore, $dateSent, $dateSentAfter);
    }
    /**
     * @param string $body The text of the message you want to send
     * @return UpdateMessageOptions Options builder
     */
    public static function update(string $body = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateMessageOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateMessageOptions($body);
    }
}
class CreateMessageOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $from The phone number that initiated the message
     * @param string $messagingServiceSid The SID of the Messaging Service you want
     ...
     * @param string[] $persistentAction Rich actions for Channels Messages.
     */
    public function __construct(string $from = \WSAL_Vendor\Twilio\Values::NONE, string $messagingServiceSid = \WSAL_Vendor\Twilio\Values::NONE, string $body = \WSAL_Vendor\Twilio\Values::NONE, array $mediaUrl = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $applicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $maxPrice = \WSAL_Vendor\Twilio\Values::NONE, bool $provideFeedback = \WSAL_Vendor\Twilio\Values::NONE, int $attempt = \WSAL_Vendor\Twilio\Values::NONE, int $validityPeriod = \WSAL_Vendor\Twilio\Values::NONE, bool $forceDelivery = \WSAL_Vendor\Twilio\Values::NONE, string $contentRetention = \WSAL_Vendor\Twilio\Values::NONE, string $addressRetention = \WSAL_Vendor\Twilio\Values::NONE, bool $smartEncoded = \WSAL_Vendor\Twilio\Values::NONE, array $persistentAction = \WSAL_Vendor\Twilio\Values::ARRAY_NONE)
    {
...
class ReadMessageOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $to Filter by messages sent to this number
     * @param string $from Filter by from number
     ...
     * @param string $dateSentAfter Filter by date sent
     */
    public function __construct(string $to = \WSAL_Vendor\Twilio\Values::NONE, string $from = \WSAL_Vendor\Twilio\Values::NONE, string $dateSentBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateSent = \WSAL_Vendor\Twilio\Values::NONE, string $dateSentAfter = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['to'] = $to;
        $this->options['from'] = $from;
...
class UpdateMessageOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $body The text of the message you want to send
     */
    public function __construct(string $body = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['body'] = $body;
    }
    /**
