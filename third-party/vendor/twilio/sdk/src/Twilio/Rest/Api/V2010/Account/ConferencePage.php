...
class ConferencePage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConferenceInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConferenceInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
