...
class CredentialListList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return CredentialListPage Page of CredentialListInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListPage
    {
     ...
     */
    public function create(string $friendlyName) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListInstance
    {
        $data = \WSAL_Vendor\Twilio\Values::of(['FriendlyName' => $friendlyName]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
