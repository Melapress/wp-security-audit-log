...
class AddOnResultPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['referenceSid']);
    }
    /**
