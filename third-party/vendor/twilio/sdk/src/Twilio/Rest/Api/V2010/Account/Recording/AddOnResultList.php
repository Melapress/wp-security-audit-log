...
class AddOnResultList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, string $accountSid, string $referenceSid)
    {
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return AddOnResultPage Page of AddOnResultInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultPage
    {
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Recording\AddOnResultContext($this->version, $this->solution['accountSid'], $this->solution['referenceSid'], $sid);
    }
    /**
