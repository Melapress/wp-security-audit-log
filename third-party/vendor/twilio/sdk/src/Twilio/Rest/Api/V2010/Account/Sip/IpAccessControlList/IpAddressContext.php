...
class IpAddressContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, $accountSid, $ipAccessControlListSid, $sid)
    {
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlList\IpAddressInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlList\IpAddressInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['ipAccessControlListSid'], $this->solution['sid']);
    }
    /**
    ...
    public function update(array $options = []) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlList\IpAddressInstance
    {
        ...
        $data = \WSAL_Vendor\Twilio\Values::of(['IpAddress' => $options['ipAddress'], 'FriendlyName' => $options['friendlyName'], 'CidrPrefixLength' => $options['cidrPrefixLength']]);
