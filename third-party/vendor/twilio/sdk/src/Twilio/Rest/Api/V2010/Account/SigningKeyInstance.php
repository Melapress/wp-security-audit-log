 ...
 */
class SigningKeyInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyContext
    {
        if (!$this->context) {
            $this->context = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyContext($this->version, $this->solution['accountSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
