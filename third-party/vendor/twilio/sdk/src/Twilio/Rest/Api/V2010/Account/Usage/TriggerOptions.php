...
abstract class TriggerOptions
{
     ...
     */
    public static function update(string $callbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $callbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\UpdateTriggerOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\UpdateTriggerOptions($callbackMethod, $callbackUrl, $friendlyName);
    }
    /**
     * @param string $callbackMethod The HTTP method to use to call callback_url
     * @param string $friendlyName A string to describe the resource
     ...
     */
    public static function create(string $callbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $recurring = \WSAL_Vendor\Twilio\Values::NONE, string $triggerBy = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\CreateTriggerOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\CreateTriggerOptions($callbackMethod, $friendlyName, $recurring, $triggerBy);
    }
    /**
     ...
     */
    public static function read(string $recurring = \WSAL_Vendor\Twilio\Values::NONE, string $triggerBy = \WSAL_Vendor\Twilio\Values::NONE, string $usageCategory = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\ReadTriggerOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\ReadTriggerOptions($recurring, $triggerBy, $usageCategory);
    }
}
class UpdateTriggerOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $callbackMethod The HTTP method to use to call callback_url
     * @param string $callbackUrl The URL we call when the trigger fires
     * @param string $friendlyName A string to describe the resource
     */
    public function __construct(string $callbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $callbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class CreateTriggerOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $callbackMethod The HTTP method to use to call callback_url
     * @param string $friendlyName A string to describe the resource
     ...
     *                          the trigger
     */
    public function __construct(string $callbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $recurring = \WSAL_Vendor\Twilio\Values::NONE, string $triggerBy = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['callbackMethod'] = $callbackMethod;
        $this->options['friendlyName'] = $friendlyName;
...
class ReadTriggerOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $recurring The frequency of recurring UsageTriggers to read
     * @param string $triggerBy The trigger field of the UsageTriggers to read
     * @param string $usageCategory The usage category of the UsageTriggers to read
     */
    public function __construct(string $recurring = \WSAL_Vendor\Twilio\Values::NONE, string $triggerBy = \WSAL_Vendor\Twilio\Values::NONE, string $usageCategory = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['recurring'] = $recurring;
        $this->options['triggerBy'] = $triggerBy;
