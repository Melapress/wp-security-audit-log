...
abstract class ValidationRequestOptions
{
     ...
     */
    public static function create(string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, int $callDelay = \WSAL_Vendor\Twilio\Values::NONE, string $extension = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CreateValidationRequestOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CreateValidationRequestOptions($friendlyName, $callDelay, $extension, $statusCallback, $statusCallbackMethod);
    }
}
class CreateValidationRequestOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $friendlyName A string to describe the resource
     * @param int $callDelay The number of seconds to delay before initiating the
     ...
     *                                     status_callback
     */
    public function __construct(string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, int $callDelay = \WSAL_Vendor\Twilio\Values::NONE, string $extension = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE)
    {
