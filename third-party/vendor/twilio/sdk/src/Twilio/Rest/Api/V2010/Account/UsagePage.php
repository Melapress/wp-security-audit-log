...
class UsagePage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UsageInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UsageInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
