...
class NotificationContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\NotificationInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\NotificationInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['callSid'], $this->solution['sid']);
    }
    /**
