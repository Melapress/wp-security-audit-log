...
class OutgoingCallerIdList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdPage
    {
        $options = new \WSAL_Vendor\Twilio\Values($options);
        $params = \WSAL_Vendor\Twilio\Values::of(['PhoneNumber' => $options['phoneNumber'], 'FriendlyName' => $options['friendlyName'], 'PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return OutgoingCallerIdPage Page of OutgoingCallerIdInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdPage
    {
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
