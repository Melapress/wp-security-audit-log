...
class OutgoingCallerIdPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
