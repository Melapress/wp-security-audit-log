...
class DependentPhoneNumberList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, string $accountSid, string $addressSid)
    {
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Address\DependentPhoneNumberPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Address\DependentPhoneNumberPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return DependentPhoneNumberPage Page of DependentPhoneNumberInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Address\DependentPhoneNumberPage
    {
