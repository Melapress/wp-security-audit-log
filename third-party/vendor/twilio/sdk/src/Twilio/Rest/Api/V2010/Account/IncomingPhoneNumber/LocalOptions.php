...
abstract class LocalOptions
{
     ...
     */
    public static function read(bool $beta = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $phoneNumber = \WSAL_Vendor\Twilio\Values::NONE, string $origin = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\ReadLocalOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\ReadLocalOptions($beta, $friendlyName, $phoneNumber, $origin);
    }
    /**
...
class ReadLocalOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param bool $beta Whether to include new phone numbers
     * @param string $friendlyName A string that identifies the resources to read
...
class CreateLocalOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $apiVersion The API version to use for incoming calls made to
     *                           the new phone number
