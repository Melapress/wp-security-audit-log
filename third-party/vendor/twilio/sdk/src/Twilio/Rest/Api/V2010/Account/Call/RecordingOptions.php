...
abstract class RecordingOptions
{
     ...
     */
    public static function create(array $recordingStatusCallbackEvent = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $recordingStatusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $trim = \WSAL_Vendor\Twilio\Values::NONE, string $recordingChannels = \WSAL_Vendor\Twilio\Values::NONE, string $recordingTrack = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\CreateRecordingOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\CreateRecordingOptions($recordingStatusCallbackEvent, $recordingStatusCallback, $recordingStatusCallbackMethod, $trim, $recordingChannels, $recordingTrack);
    }
    /**
     ...
     */
    public static function update(string $pauseBehavior = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\UpdateRecordingOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\UpdateRecordingOptions($pauseBehavior);
    }
    /**
     ...
     */
    public static function read(string $dateCreatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreated = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreatedAfter = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\ReadRecordingOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\ReadRecordingOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter);
    }
}
class CreateRecordingOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string[] $recordingStatusCallbackEvent The recording status changes
     *                                               that should generate a callback
     ...
     * @param string $recordingTrack Which track(s) to record
     */
    public function __construct(array $recordingStatusCallbackEvent = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $recordingStatusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $trim = \WSAL_Vendor\Twilio\Values::NONE, string $recordingChannels = \WSAL_Vendor\Twilio\Values::NONE, string $recordingTrack = \WSAL_Vendor\Twilio\Values::NONE)
    {
