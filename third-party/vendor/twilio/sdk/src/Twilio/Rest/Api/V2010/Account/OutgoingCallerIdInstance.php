 ...
 * @property string $uri
 */
class OutgoingCallerIdInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
    /**
     ...
     */
    protected function proxy() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
        if (!$this->context) {
            $this->context = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext($this->version, $this->solution['accountSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
