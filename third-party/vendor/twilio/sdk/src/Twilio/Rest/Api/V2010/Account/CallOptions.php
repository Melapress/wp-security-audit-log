...
abstract class CallOptions
{
     ...
     */
    public static function create(string $url = \WSAL_Vendor\Twilio\Values::NONE, string $twiml = \WSAL_Vendor\Twilio\Values::NONE, string $applicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $method = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, array $statusCallbackEvent = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $sendDigits = \WSAL_Vendor\Twilio\Values::NONE, int $timeout = \WSAL_Vendor\Twilio\Values::NONE, bool $record = \WSAL_Vendor\Twilio\Values::NONE, string $recordingChannels = \WSAL_Vendor\Twilio\Values::NONE, string $recordingStatusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $sipAuthUsername = \WSAL_Vendor\Twilio\Values::NONE, string $sipAuthPassword = \WSAL_Vendor\Twilio\Values::NONE, string $machineDetection = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionTimeout = \WSAL_Vendor\Twilio\Values::NONE, array $recordingStatusCallbackEvent = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $trim = \WSAL_Vendor\Twilio\Values::NONE, string $callerId = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionSpeechThreshold = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionSpeechEndThreshold = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionSilenceTimeout = \WSAL_Vendor\Twilio\Values::NONE, string $asyncAmd = \WSAL_Vendor\Twilio\Values::NONE, string $asyncAmdStatusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $asyncAmdStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $byoc = \WSAL_Vendor\Twilio\Values::NONE, string $callReason = \WSAL_Vendor\Twilio\Values::NONE, string $callToken = \WSAL_Vendor\Twilio\Values::NONE, string $recordingTrack = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CreateCallOptions
    {
     ...
     */
    public static function read(string $to = \WSAL_Vendor\Twilio\Values::NONE, string $from = \WSAL_Vendor\Twilio\Values::NONE, string $parentCallSid = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE, string $startTimeBefore = \WSAL_Vendor\Twilio\Values::NONE, string $startTime = \WSAL_Vendor\Twilio\Values::NONE, string $startTimeAfter = \WSAL_Vendor\Twilio\Values::NONE, string $endTimeBefore = \WSAL_Vendor\Twilio\Values::NONE, string $endTime = \WSAL_Vendor\Twilio\Values::NONE, string $endTimeAfter = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadCallOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadCallOptions($to, $from, $parentCallSid, $status, $startTimeBefore, $startTime, $startTimeAfter, $endTimeBefore, $endTime, $endTimeAfter);
    }
    /**
     * @param string $url The absolute URL that returns TwiML for this call
     * @param string $method HTTP method to use to fetch TwiML
     ...
     */
    public static function update(string $url = \WSAL_Vendor\Twilio\Values::NONE, string $method = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $twiml = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateCallOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateCallOptions($url, $method, $status, $fallbackUrl, $fallbackMethod, $statusCallback, $statusCallbackMethod, $twiml);
    }
}
class CreateCallOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $url The absolute URL that returns TwiML for this call
     * @param string $twiml TwiML instructions for the call
     ...
     * @param string $recordingTrack Which track(s) to record
     */
    public function __construct(string $url = \WSAL_Vendor\Twilio\Values::NONE, string $twiml = \WSAL_Vendor\Twilio\Values::NONE, string $applicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $method = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, array $statusCallbackEvent = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $sendDigits = \WSAL_Vendor\Twilio\Values::NONE, int $timeout = \WSAL_Vendor\Twilio\Values::NONE, bool $record = \WSAL_Vendor\Twilio\Values::NONE, string $recordingChannels = \WSAL_Vendor\Twilio\Values::NONE, string $recordingStatusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $recordingStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $sipAuthUsername = \WSAL_Vendor\Twilio\Values::NONE, string $sipAuthPassword = \WSAL_Vendor\Twilio\Values::NONE, string $machineDetection = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionTimeout = \WSAL_Vendor\Twilio\Values::NONE, array $recordingStatusCallbackEvent = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $trim = \WSAL_Vendor\Twilio\Values::NONE, string $callerId = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionSpeechThreshold = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionSpeechEndThreshold = \WSAL_Vendor\Twilio\Values::NONE, int $machineDetectionSilenceTimeout = \WSAL_Vendor\Twilio\Values::NONE, string $asyncAmd = \WSAL_Vendor\Twilio\Values::NONE, string $asyncAmdStatusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $asyncAmdStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $byoc = \WSAL_Vendor\Twilio\Values::NONE, string $callReason = \WSAL_Vendor\Twilio\Values::NONE, string $callToken = \WSAL_Vendor\Twilio\Values::NONE, string $recordingTrack = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class ReadCallOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $to Phone number or Client identifier of calls to include
     * @param string $from Phone number or Client identifier to filter `from` on
     ...
     * @param string $endTimeAfter Only include calls that ended on this date
     */
    public function __construct(string $to = \WSAL_Vendor\Twilio\Values::NONE, string $from = \WSAL_Vendor\Twilio\Values::NONE, string $parentCallSid = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE, string $startTimeBefore = \WSAL_Vendor\Twilio\Values::NONE, string $startTime = \WSAL_Vendor\Twilio\Values::NONE, string $startTimeAfter = \WSAL_Vendor\Twilio\Values::NONE, string $endTimeBefore = \WSAL_Vendor\Twilio\Values::NONE, string $endTime = \WSAL_Vendor\Twilio\Values::NONE, string $endTimeAfter = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['to'] = $to;
...
class UpdateCallOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $url The absolute URL that returns TwiML for this call
     * @param string $method HTTP method to use to fetch TwiML
     ...
     * @param string $twiml TwiML instructions for the call
     */
    public function __construct(string $url = \WSAL_Vendor\Twilio\Values::NONE, string $method = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $fallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $twiml = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['url'] = $url;
        $this->options['method'] = $method;
        $this->options['status'] = $status;
