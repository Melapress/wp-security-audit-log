 ...
 * @property string $uri
 */
class PaymentInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
    /**
    ...
    public function __construct(\WSAL_Vendor\Twilio\Version $version, array $payload, string $accountSid, string $callSid, string $sid = null)
    {
        ...
        $this->properties = ['accountSid' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'account_sid'), 'callSid' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'call_sid'), 'sid' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'sid'), 'dateCreated' => \WSAL_Vendor\Twilio\Deserialize::dateTime(\WSAL_Vendor\Twilio\Values::array_get($payload, 'date_created')), 'dateUpdated' => \WSAL_Vendor\Twilio\Deserialize::dateTime(\WSAL_Vendor\Twilio\Values::array_get($payload, 'date_updated')), 'uri' => \WSAL_Vendor\Twilio\Values::array_get($payload, 'uri')];
     ...
     */
    protected function proxy() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\PaymentContext
    {
        if (!$this->context) {
            $this->context = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\PaymentContext($this->version, $this->solution['accountSid'], $this->solution['callSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
