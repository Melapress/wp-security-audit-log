...
abstract class IncomingPhoneNumberOptions
{
     ...
     */
    public static function update(string $accountSid = \WSAL_Vendor\Twilio\Values::NONE, string $apiVersion = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $smsApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $smsMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsUrl = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyStatus = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyAddressSid = \WSAL_Vendor\Twilio\Values::NONE, string $trunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $voiceReceiveMode = \WSAL_Vendor\Twilio\Values::NONE, string $identitySid = \WSAL_Vendor\Twilio\Values::NONE, string $addressSid = \WSAL_Vendor\Twilio\Values::NONE, string $bundleSid = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateIncomingPhoneNumberOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateIncomingPhoneNumberOptions($accountSid, $apiVersion, $friendlyName, $smsApplicationSid, $smsFallbackMethod, $smsFallbackUrl, $smsMethod, $smsUrl, $statusCallback, $statusCallbackMethod, $voiceApplicationSid, $voiceCallerIdLookup, $voiceFallbackMethod, $voiceFallbackUrl, $voiceMethod, $voiceUrl, $emergencyStatus, $emergencyAddressSid, $trunkSid, $voiceReceiveMode, $identitySid, $addressSid, $bundleSid);
    }
    /**
     ...
     */
    public static function read(bool $beta = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $phoneNumber = \WSAL_Vendor\Twilio\Values::NONE, string $origin = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadIncomingPhoneNumberOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadIncomingPhoneNumberOptions($beta, $friendlyName, $phoneNumber, $origin);
    }
    /**
     ...
     */
    public static function create(string $phoneNumber = \WSAL_Vendor\Twilio\Values::NONE, string $areaCode = \WSAL_Vendor\Twilio\Values::NONE, string $apiVersion = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $smsApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $smsMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsUrl = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyStatus = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyAddressSid = \WSAL_Vendor\Twilio\Values::NONE, string $trunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $identitySid = \WSAL_Vendor\Twilio\Values::NONE, string $addressSid = \WSAL_Vendor\Twilio\Values::NONE, string $voiceReceiveMode = \WSAL_Vendor\Twilio\Values::NONE, string $bundleSid = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CreateIncomingPhoneNumberOptions
    {
...
class UpdateIncomingPhoneNumberOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $accountSid The SID of the Account that created the resource
     *                           to update
     ...
     *                          number
     */
    public function __construct(string $accountSid = \WSAL_Vendor\Twilio\Values::NONE, string $apiVersion = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $smsApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $smsMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsUrl = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyStatus = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyAddressSid = \WSAL_Vendor\Twilio\Values::NONE, string $trunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $voiceReceiveMode = \WSAL_Vendor\Twilio\Values::NONE, string $identitySid = \WSAL_Vendor\Twilio\Values::NONE, string $addressSid = \WSAL_Vendor\Twilio\Values::NONE, string $bundleSid = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class ReadIncomingPhoneNumberOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param bool $beta Whether to include new phone numbers
     * @param string $friendlyName A string that identifies the IncomingPhoneNumber
     ...
     *                       default, phone numbers of all origin are included.
     */
    public function __construct(bool $beta = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $phoneNumber = \WSAL_Vendor\Twilio\Values::NONE, string $origin = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class CreateIncomingPhoneNumberOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $phoneNumber The phone number to purchase in E.164 format
     * @param string $areaCode The desired area code for the new phone number
     ...
     *                          number
     */
    public function __construct(string $phoneNumber = \WSAL_Vendor\Twilio\Values::NONE, string $areaCode = \WSAL_Vendor\Twilio\Values::NONE, string $apiVersion = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $smsApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $smsMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsUrl = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyStatus = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyAddressSid = \WSAL_Vendor\Twilio\Values::NONE, string $trunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $identitySid = \WSAL_Vendor\Twilio\Values::NONE, string $addressSid = \WSAL_Vendor\Twilio\Values::NONE, string $voiceReceiveMode = \WSAL_Vendor\Twilio\Values::NONE, string $bundleSid = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['phoneNumber'] = $phoneNumber;
