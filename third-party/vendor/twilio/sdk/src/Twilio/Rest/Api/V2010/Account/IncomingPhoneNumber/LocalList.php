...
class LocalList extends \WSAL_Vendor\Twilio\ListResource
{
     ...
     */
    public function page(array $options = [], $pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\LocalPage
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\LocalPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return LocalPage Page of LocalInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\LocalPage
    {
     ...
     */
    public function create(string $phoneNumber, array $options = []) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\LocalInstance
    {
        $options = new \WSAL_Vendor\Twilio\Values($options);
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\LocalInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
