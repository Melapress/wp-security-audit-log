...
abstract class ConferenceOptions
{
     ...
     */
    public static function read(string $dateCreatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreated = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreatedAfter = \WSAL_Vendor\Twilio\Values::NONE, string $dateUpdatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateUpdated = \WSAL_Vendor\Twilio\Values::NONE, string $dateUpdatedAfter = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadConferenceOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ReadConferenceOptions($dateCreatedBefore, $dateCreated, $dateCreatedAfter, $dateUpdatedBefore, $dateUpdated, $dateUpdatedAfter, $friendlyName, $status);
    }
    /**
     ...
     */
    public static function update(string $status = \WSAL_Vendor\Twilio\Values::NONE, string $announceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $announceMethod = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateConferenceOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\UpdateConferenceOptions($status, $announceUrl, $announceMethod);
    }
}
class ReadConferenceOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $dateCreatedBefore The `YYYY-MM-DD` value of the resources to
     *                                  read
     ...
     * @param string $status The status of the resources to read
     */
    public function __construct(string $dateCreatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreated = \WSAL_Vendor\Twilio\Values::NONE, string $dateCreatedAfter = \WSAL_Vendor\Twilio\Values::NONE, string $dateUpdatedBefore = \WSAL_Vendor\Twilio\Values::NONE, string $dateUpdated = \WSAL_Vendor\Twilio\Values::NONE, string $dateUpdatedAfter = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class UpdateConferenceOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $status The new status of the resource
     * @param string $announceUrl The URL we should call to announce something into
     ...
     * @param string $announceMethod he HTTP method used to call announce_url
     */
    public function __construct(string $status = \WSAL_Vendor\Twilio\Values::NONE, string $announceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $announceMethod = \WSAL_Vendor\Twilio\Values::NONE)
    {
        $this->options['status'] = $status;
