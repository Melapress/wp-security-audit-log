 ...
 */
class CredentialListContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialListInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['sid']);
    }
    /**
    ...
    protected function getCredentials() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialList
    {
        if (!$this->_credentials) {
            $this->_credentials = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CredentialList\CredentialList($this->version, $this->solution['accountSid'], $this->solution['sid']);
        }
