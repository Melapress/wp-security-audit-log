...
abstract class MachineToMachineOptions
{
     ...
     */
    public static function read(int $areaCode = \WSAL_Vendor\Twilio\Values::NONE, string $contains = \WSAL_Vendor\Twilio\Values::NONE, bool $smsEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $mmsEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $excludeAllAddressRequired = \WSAL_Vendor\Twilio\Values::NONE, bool $excludeLocalAddressRequired = \WSAL_Vendor\Twilio\Values::NONE, bool $excludeForeignAddressRequired = \WSAL_Vendor\Twilio\Values::NONE, bool $beta = \WSAL_Vendor\Twilio\Values::NONE, string $nearNumber = \WSAL_Vendor\Twilio\Values::NONE, string $nearLatLong = \WSAL_Vendor\Twilio\Values::NONE, int $distance = \WSAL_Vendor\Twilio\Values::NONE, string $inPostalCode = \WSAL_Vendor\Twilio\Values::NONE, string $inRegion = \WSAL_Vendor\Twilio\Values::NONE, string $inRateCenter = \WSAL_Vendor\Twilio\Values::NONE, string $inLata = \WSAL_Vendor\Twilio\Values::NONE, string $inLocality = \WSAL_Vendor\Twilio\Values::NONE, bool $faxEnabled = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\ReadMachineToMachineOptions
    {
...
class ReadMachineToMachineOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param int $areaCode The area code of the phone numbers to read
     * @param string $contains The pattern on which to match phone numbers
     ...
     * @param bool $faxEnabled Whether the phone numbers can receive faxes
     */
    public function __construct(int $areaCode = \WSAL_Vendor\Twilio\Values::NONE, string $contains = \WSAL_Vendor\Twilio\Values::NONE, bool $smsEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $mmsEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $excludeAllAddressRequired = \WSAL_Vendor\Twilio\Values::NONE, bool $excludeLocalAddressRequired = \WSAL_Vendor\Twilio\Values::NONE, bool $excludeForeignAddressRequired = \WSAL_Vendor\Twilio\Values::NONE, bool $beta = \WSAL_Vendor\Twilio\Values::NONE, string $nearNumber = \WSAL_Vendor\Twilio\Values::NONE, string $nearLatLong = \WSAL_Vendor\Twilio\Values::NONE, int $distance = \WSAL_Vendor\Twilio\Values::NONE, string $inPostalCode = \WSAL_Vendor\Twilio\Values::NONE, string $inRegion = \WSAL_Vendor\Twilio\Values::NONE, string $inRateCenter = \WSAL_Vendor\Twilio\Values::NONE, string $inLata = \WSAL_Vendor\Twilio\Values::NONE, string $inLocality = \WSAL_Vendor\Twilio\Values::NONE, bool $faxEnabled = \WSAL_Vendor\Twilio\Values::NONE)
    {
