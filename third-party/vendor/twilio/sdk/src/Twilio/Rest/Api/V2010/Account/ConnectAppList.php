...
class ConnectAppList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ConnectAppPage Page of ConnectAppInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppPage
    {
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
