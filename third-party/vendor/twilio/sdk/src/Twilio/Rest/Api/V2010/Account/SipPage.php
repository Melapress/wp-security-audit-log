...
class SipPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SipInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SipInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
