 ...
 */
class AssignedAddOnExtensionContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Twilio\Version $version, $accountSid, $resourceSid, $assignedAddOnSid, $sid)
    {
    ...
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\AssignedAddOn\AssignedAddOnExtensionInstance
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\AssignedAddOn\AssignedAddOnExtensionInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['resourceSid'], $this->solution['assignedAddOnSid'], $this->solution['sid']);
    }
    /**
