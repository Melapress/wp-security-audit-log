...
class FeedbackInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\FeedbackContext
    {
        if (!$this->context) {
            $this->context = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\FeedbackContext($this->version, $this->solution['accountSid'], $this->solution['callSid']);
        }
        return $this->context;
    }
    /**
