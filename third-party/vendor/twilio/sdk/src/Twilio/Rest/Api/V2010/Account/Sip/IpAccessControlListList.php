...
class IpAccessControlListList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page($pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListPage
    {
        $params = \WSAL_Vendor\Twilio\Values::of(['PageToken' => $pageToken, 'Page' => $pageNumber, 'PageSize' => $pageSize]);
        $response = $this->version->page('GET', $this->uri, $params);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return IpAccessControlListPage Page of IpAccessControlListInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListPage
    {
     ...
     */
    public function create(string $friendlyName) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListInstance
    {
        $data = \WSAL_Vendor\Twilio\Values::of(['FriendlyName' => $friendlyName]);
        $payload = $this->version->create('POST', $this->uri, [], $data);
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
     ...
     */
    public function getContext(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListContext
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\IpAccessControlListContext($this->version, $this->solution['accountSid'], $sid);
    }
    /**
