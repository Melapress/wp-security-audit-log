 ...
 */
class IncomingPhoneNumberContext extends \WSAL_Vendor\Twilio\InstanceContext
{
    ...
    protected function getAssignedAddOns() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\AssignedAddOnList
    {
        if (!$this->_assignedAddOns) {
            $this->_assignedAddOns = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\AssignedAddOnList($this->version, $this->solution['accountSid'], $this->solution['sid']);
        }
