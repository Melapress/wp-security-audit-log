...
abstract class TollFreeOptions
{
     ...
     */
    public static function read(bool $beta = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $phoneNumber = \WSAL_Vendor\Twilio\Values::NONE, string $origin = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\ReadTollFreeOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\ReadTollFreeOptions($beta, $friendlyName, $phoneNumber, $origin);
    }
    /**
     ...
     */
    public static function create(string $apiVersion = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $smsApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $smsMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsUrl = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $identitySid = \WSAL_Vendor\Twilio\Values::NONE, string $addressSid = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyStatus = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyAddressSid = \WSAL_Vendor\Twilio\Values::NONE, string $trunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $voiceReceiveMode = \WSAL_Vendor\Twilio\Values::NONE, string $bundleSid = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumber\CreateTollFreeOptions
    {
...
class ReadTollFreeOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param bool $beta Whether to include new phone numbers
     * @param string $friendlyName A string that identifies the resources to read
...
class CreateTollFreeOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $apiVersion The API version to use for incoming calls made to
     *                           the new phone number
     ...
     *                          number
     */
    public function __construct(string $apiVersion = \WSAL_Vendor\Twilio\Values::NONE, string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $smsApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $smsMethod = \WSAL_Vendor\Twilio\Values::NONE, string $smsUrl = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallback = \WSAL_Vendor\Twilio\Values::NONE, string $statusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceApplicationSid = \WSAL_Vendor\Twilio\Values::NONE, bool $voiceCallerIdLookup = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $identitySid = \WSAL_Vendor\Twilio\Values::NONE, string $addressSid = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyStatus = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyAddressSid = \WSAL_Vendor\Twilio\Values::NONE, string $trunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $voiceReceiveMode = \WSAL_Vendor\Twilio\Values::NONE, string $bundleSid = \WSAL_Vendor\Twilio\Values::NONE)
    {
