...
abstract class PaymentOptions
{
     ...
     */
    public static function create(string $bankAccountType = \WSAL_Vendor\Twilio\Values::NONE, string $chargeAmount = \WSAL_Vendor\Twilio\Values::NONE, string $currency = \WSAL_Vendor\Twilio\Values::NONE, string $description = \WSAL_Vendor\Twilio\Values::NONE, string $input = \WSAL_Vendor\Twilio\Values::NONE, int $minPostalCodeLength = \WSAL_Vendor\Twilio\Values::NONE, array $parameter = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $paymentConnector = \WSAL_Vendor\Twilio\Values::NONE, string $paymentMethod = \WSAL_Vendor\Twilio\Values::NONE, bool $postalCode = \WSAL_Vendor\Twilio\Values::NONE, bool $securityCode = \WSAL_Vendor\Twilio\Values::NONE, int $timeout = \WSAL_Vendor\Twilio\Values::NONE, string $tokenType = \WSAL_Vendor\Twilio\Values::NONE, string $validCardTypes = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\CreatePaymentOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\CreatePaymentOptions($bankAccountType, $chargeAmount, $currency, $description, $input, $minPostalCodeLength, $parameter, $paymentConnector, $paymentMethod, $postalCode, $securityCode, $timeout, $tokenType, $validCardTypes);
    }
    /**
     ...
     */
    public static function update(string $capture = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\UpdatePaymentOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\UpdatePaymentOptions($capture, $status);
    }
}
class CreatePaymentOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $bankAccountType Type of bank account if payment source is ACH.
     * @param string $chargeAmount A positive decimal value less than 1,000,000 to
     ...
     *                               should accept.
     */
    public function __construct(string $bankAccountType = \WSAL_Vendor\Twilio\Values::NONE, string $chargeAmount = \WSAL_Vendor\Twilio\Values::NONE, string $currency = \WSAL_Vendor\Twilio\Values::NONE, string $description = \WSAL_Vendor\Twilio\Values::NONE, string $input = \WSAL_Vendor\Twilio\Values::NONE, int $minPostalCodeLength = \WSAL_Vendor\Twilio\Values::NONE, array $parameter = \WSAL_Vendor\Twilio\Values::ARRAY_NONE, string $paymentConnector = \WSAL_Vendor\Twilio\Values::NONE, string $paymentMethod = \WSAL_Vendor\Twilio\Values::NONE, bool $postalCode = \WSAL_Vendor\Twilio\Values::NONE, bool $securityCode = \WSAL_Vendor\Twilio\Values::NONE, int $timeout = \WSAL_Vendor\Twilio\Values::NONE, string $tokenType = \WSAL_Vendor\Twilio\Values::NONE, string $validCardTypes = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class UpdatePaymentOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $capture The piece of payment information that you wish the
     *                        caller to enter.
     ...
     *                       be cancelled or completed.
     */
    public function __construct(string $capture = \WSAL_Vendor\Twilio\Values::NONE, string $status = \WSAL_Vendor\Twilio\Values::NONE)
    {
