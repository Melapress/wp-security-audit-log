...
class TranscriptionInstance extends \WSAL_Vendor\Twilio\InstanceResource
{
     ...
     */
    protected function proxy() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext
    {
        if (!$this->context) {
            $this->context = new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext($this->version, $this->solution['accountSid'], $this->solution['sid']);
        }
        return $this->context;
    }
    /**
     ...
     */
    public function fetch() : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionInstance
    {
