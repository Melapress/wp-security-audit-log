...
class YearlyPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\YearlyInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\YearlyInstance($this->version, $payload, $this->solution['accountSid']);
    }
    /**
