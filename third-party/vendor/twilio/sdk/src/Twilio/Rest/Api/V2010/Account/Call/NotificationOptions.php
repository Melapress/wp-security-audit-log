...
abstract class NotificationOptions
{
     ...
     */
    public static function read(int $log = \WSAL_Vendor\Twilio\Values::NONE, string $messageDateBefore = \WSAL_Vendor\Twilio\Values::NONE, string $messageDate = \WSAL_Vendor\Twilio\Values::NONE, string $messageDateAfter = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\ReadNotificationOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\ReadNotificationOptions($log, $messageDateBefore, $messageDate, $messageDateAfter);
    }
}
