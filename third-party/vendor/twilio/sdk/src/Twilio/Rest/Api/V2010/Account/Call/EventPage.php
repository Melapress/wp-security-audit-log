...
class EventPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\EventInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\EventInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['callSid']);
    }
    /**
