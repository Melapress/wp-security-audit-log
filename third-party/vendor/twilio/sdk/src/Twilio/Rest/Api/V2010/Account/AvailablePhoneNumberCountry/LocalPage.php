...
class LocalPage extends \WSAL_Vendor\Twilio\Page
{
    /**
     ...
     */
    public function buildInstance(array $payload) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\LocalInstance
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountry\LocalInstance($this->version, $payload, $this->solution['accountSid'], $this->solution['countryCode']);
    }
    /**
