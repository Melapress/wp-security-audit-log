...
class ThisMonthList extends \WSAL_Vendor\Twilio\ListResource
{
    /**
     ...
     */
    public function page(array $options = [], $pageSize = \WSAL_Vendor\Twilio\Values::NONE, string $pageToken = \WSAL_Vendor\Twilio\Values::NONE, $pageNumber = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\ThisMonthPage
    {
        ...
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\ThisMonthPage($this->version, $response, $this->solution);
    }
    /**
     ...
     * @return ThisMonthPage Page of ThisMonthInstance
     */
    public function getPage(string $targetUrl) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Usage\Record\ThisMonthPage
    {
