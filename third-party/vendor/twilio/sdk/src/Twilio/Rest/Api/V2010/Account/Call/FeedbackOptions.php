...
abstract class FeedbackOptions
{
     ...
     */
    public static function create(array $issue = \WSAL_Vendor\Twilio\Values::ARRAY_NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\CreateFeedbackOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\CreateFeedbackOptions($issue);
    }
    /**
     ...
     */
    public static function update(int $qualityScore = \WSAL_Vendor\Twilio\Values::NONE, array $issue = \WSAL_Vendor\Twilio\Values::ARRAY_NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\UpdateFeedbackOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Call\UpdateFeedbackOptions($qualityScore, $issue);
    }
}
class CreateFeedbackOptions extends \WSAL_Vendor\Twilio\Options
{
     ...
     * @param string[] $issue Issues experienced during the call
     */
    public function __construct(array $issue = \WSAL_Vendor\Twilio\Values::ARRAY_NONE)
    {
...
class UpdateFeedbackOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param int $qualityScore The call quality expressed as an integer from 1 to 5
     * @param string[] $issue Issues experienced during the call
     */
    public function __construct(int $qualityScore = \WSAL_Vendor\Twilio\Values::NONE, array $issue = \WSAL_Vendor\Twilio\Values::ARRAY_NONE)
    {
