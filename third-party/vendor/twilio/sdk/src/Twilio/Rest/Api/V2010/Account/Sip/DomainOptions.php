...
abstract class DomainOptions
{
     ...
     */
    public static function create(string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, bool $sipRegistration = \WSAL_Vendor\Twilio\Values::NONE, bool $emergencyCallingEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $secure = \WSAL_Vendor\Twilio\Values::NONE, string $byocTrunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyCallerSid = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CreateDomainOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\CreateDomainOptions($friendlyName, $voiceUrl, $voiceMethod, $voiceFallbackUrl, $voiceFallbackMethod, $voiceStatusCallbackUrl, $voiceStatusCallbackMethod, $sipRegistration, $emergencyCallingEnabled, $secure, $byocTrunkSid, $emergencyCallerSid);
    }
    /**
     * @param string $friendlyName A string to describe the resource
     ...
     */
    public static function update(string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, bool $sipRegistration = \WSAL_Vendor\Twilio\Values::NONE, string $domainName = \WSAL_Vendor\Twilio\Values::NONE, bool $emergencyCallingEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $secure = \WSAL_Vendor\Twilio\Values::NONE, string $byocTrunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyCallerSid = \WSAL_Vendor\Twilio\Values::NONE) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\UpdateDomainOptions
    {
        return new \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\Sip\UpdateDomainOptions($friendlyName, $voiceFallbackMethod, $voiceFallbackUrl, $voiceMethod, $voiceStatusCallbackMethod, $voiceStatusCallbackUrl, $voiceUrl, $sipRegistration, $domainName, $emergencyCallingEnabled, $secure, $byocTrunkSid, $emergencyCallerSid);
    }
}
class CreateDomainOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $friendlyName A string to describe the resource
     * @param string $voiceUrl The URL we should call when receiving a call
     ...
     *                                   configured for the domain.
     */
    public function __construct(string $friendlyName = \WSAL_Vendor\Twilio\Values::NONE, string $voiceUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceFallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, string $voiceStatusCallbackUrl = \WSAL_Vendor\Twilio\Values::NONE, string $voiceStatusCallbackMethod = \WSAL_Vendor\Twilio\Values::NONE, bool $sipRegistration = \WSAL_Vendor\Twilio\Values::NONE, bool $emergencyCallingEnabled = \WSAL_Vendor\Twilio\Values::NONE, bool $secure = \WSAL_Vendor\Twilio\Values::NONE, string $byocTrunkSid = \WSAL_Vendor\Twilio\Values::NONE, string $emergencyCallerSid = \WSAL_Vendor\Twilio\Values::NONE)
    {
...
class UpdateDomainOptions extends \WSAL_Vendor\Twilio\Options
{
    /**
     * @param string $friendlyName A string to describe the resource
     * @param string $voiceFallbackMethod The HTTP method used with
