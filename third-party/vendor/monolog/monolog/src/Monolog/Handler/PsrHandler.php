 ...
 */
class PsrHandler extends \WSAL_Vendor\Monolog\Handler\AbstractHandler implements \WSAL_Vendor\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\WSAL_Vendor\Psr\Log\LoggerInterface $logger, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
