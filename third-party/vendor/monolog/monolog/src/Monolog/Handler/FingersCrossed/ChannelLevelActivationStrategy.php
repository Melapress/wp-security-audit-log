 ...
 */
class ChannelLevelActivationStrategy implements \WSAL_Vendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \WSAL_Vendor\Monolog\Logger::toMonologLevel($defaultActionLevel);
