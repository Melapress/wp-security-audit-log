 ...
 */
class SocketHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var string */
     ...
     */
    public function __construct(string $connectionString, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
