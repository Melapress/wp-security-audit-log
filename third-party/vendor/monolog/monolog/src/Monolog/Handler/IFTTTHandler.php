 ...
 */
class IFTTTHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var string */
    private $eventName;
    /** @var string */
     ...
     */
    public function __construct(string $eventName, string $secretKey, $level = \WSAL_Vendor\Monolog\Logger::ERROR, bool $bubble = \true)
    {
