 ...
 */
class CouchDBHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var mixed[] */
    private $options;
    /**
     * @param mixed[] $options
     */
    public function __construct(array $options = [], $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
