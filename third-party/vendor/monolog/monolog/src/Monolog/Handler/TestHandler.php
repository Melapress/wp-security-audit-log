 ...
 */
class TestHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\WSAL_Vendor\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
