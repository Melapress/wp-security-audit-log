 ...
 */
class RedisHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
