 ...
 */
class RotatingFileHandler extends \WSAL_Vendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \WSAL_Vendor\Monolog\Utils::canonicalizePath($filename);
