 ...
 */
class SqsHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    /** @var string */
    private $queueUrl;
    public function __construct(\Aws\Sqs\SqsClient $sqsClient, string $queueUrl, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if (\strlen($messageBody) >= static::MAX_MESSAGE_SIZE) {
            $messageBody = \WSAL_Vendor\Monolog\Utils::substr($messageBody, 0, static::HEAD_MESSAGE_SIZE);
        }
