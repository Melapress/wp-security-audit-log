 ...
 */
class StreamHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($stream, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        ...
        if (\is_resource($stream)) {
            ...
            $this->url = \WSAL_Vendor\Monolog\Utils::canonicalizePath($stream);
        } else {
