 ...
 */
class TelegramBotHandler extends \WSAL_Vendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $apiKey, string $channel, $level = \WSAL_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true, string $parseMode = null, bool $disableWebPagePreview = null, bool $disableNotification = null)
    {
    ...
    protected function send(string $message) : void
    {
        ...
        $result = \WSAL_Vendor\Monolog\Handler\Curl\Util::execute($ch);
        if (!\is_string($result)) {
