 ...
 */
class NativeMailerHandler extends \WSAL_Vendor\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \WSAL_Vendor\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \WSAL_Vendor\Monolog\Formatter\LineFormatter($this->subject);
