...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\WSAL_Vendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \WSAL_Vendor\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \WSAL_Vendor\Monolog\Logger
    {
