 ...
 */
class LineFormatter extends \WSAL_Vendor\Monolog\Formatter\NormalizerFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (\false !== \strpos($output, '%')) {
            ...
            if (null === $output) {
                ...
                throw new \RuntimeException('Failed to run preg_replace: ' . $pcreErrorCode . ' / ' . \WSAL_Vendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
            }
        }
        return $output;
    }
    ...
    {
        $str = '[object] (' . \WSAL_Vendor\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
