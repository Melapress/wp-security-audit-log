...
> 
> WP White Security provides support for WP Security Audit Log plugin on the WordPress forums for free, though it is not always possible to provide support in a timely manner (it is free).
> Personalized premium support is available via email to anyone who purchases the [Notifications Extension](http://www.wpwhitesecurity.com/plugins-premium-extensions/email-notifications-wordpress/), an exttension that allows WordPress administrators and owners to be instantly notified of changes on their WordPress via email.
...
= Notifications Extension (Premium Extension) =
<strong>Get notified instantly via email of important changes happening on your WordPress blogs and websites.</strong>

Use the [Notifications Extension](http://www.wpwhitesecurity.com/plugins-premium-extensions/email-notifications-wordpress/) to configure monitoring rules and get notified via email of specific actions, for example to check if someone logs in during the odd out of office hours. Should it happen you will receive an email with all the details of what happened, including the source IP address, user, user role, date, time and much more.
