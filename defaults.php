...
function wsaldefaults_wsal_init(WpSecurityAuditLog $wsal)
{
    ...
    $wsal->alerts->RegisterGroup(array(
            ...
            __('Custom Posts', 'wp-security-audit-log') => array(
                ...
                array(2067, E_WARNING, __('User modified content for a published custom post type', 'wp-security-audit-log'), __('Modified the content of the published custom post type %PostTitle%. Post URL is %PostUrl%.'.'%RevisionLink%. %EditorLinkPost%.', 'wp-security-audit-log')),
                array(2070, E_NOTICE, __('User modified content for a draft custom post type', 'wp-security-audit-log'), __('Modified the content of the draft custom post type %PostTitle%.'.'%RevisionLink%. %EditorLinkPost%.', 'wp-security-audit-log')),
