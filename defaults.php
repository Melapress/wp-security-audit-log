...
WpSecurityAuditLog::GetInstance()
	->alerts->RegisterGroup(array(
		...
		'Blog Posts' => array(
			...
			array(2014, E_CRITICAL, 'User restored a blog post from trash', ''),
		...
		'Pages' => array(
			...
			array(2015, E_CRITICAL, 'User restored a WordPress page from trash', ''),
		...
		'Custom Posts' => array(
			...
			array(2035, E_CRITICAL, 'User restored post with custom post type from trash', ''),
		...
		'User Profiles' => array(
			array(4000, E_CRITICAL, 'A new user was created on WordPress', ''),
			array(4001, E_CRITICAL, 'A user created another WordPress user', ''),
			array(4002, E_CRITICAL, 'The role of a user was changed by another WordPress user', ''),
			array(4003, E_CRITICAL, 'User has changed his or her password', ''),
			array(4004, E_CRITICAL, 'A user changed another user\'s password', ''),
			array(4005, E_NOTICE, 'User changed his or her email address', ''),
			array(4006, E_NOTICE, 'A user changed another user\'s email address', ''),
			array(4007, E_CRITICAL, 'A user was deleted by another user', ''),
		),
		...
		'System Activity' => array(
			...
			array(6004, E_CRITICAL, 'WordPress was updated', ''),
		...
		'MultiSite' => array(
			array(4008, E_CRITICAL, 'User granted Super Admin privileges', ''),
			array(4009, E_CRITICAL, 'User revoked from Super Admin privileges', ''),
			array(4010, E_CRITICAL, 'Existing user added to a site', ''),
			array(4011, E_CRITICAL, 'User removed from site', ''),
			array(4012, E_CRITICAL, 'New network user created', ''),
