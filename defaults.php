...
function wsaldefaults_wsal_init(WpSecurityAuditLog $wsal)
{
    ...
    $wsal->alerts->RegisterGroup(array(
        ...
        __('WooCommerce', 'wp-security-audit-log') => array(
            ...
            array(9002, E_NOTICE, __('User created a new product category', 'wp-security-audit-log'), __('Created a new product category called %Category% in WooCommerce. Product category slug is %Slug%.', 'wp-security-audit-log')),
            array(9003, E_NOTICE, __('User changed the category of a product', 'wp-security-audit-log'), __('Changed the category of the product %ProductTitle% from %OldCategory% to %NewCategory%. View the product: %EditorLinkProduct%.', 'wp-security-audit-log')),
            ...
            array(9016, E_WARNING, __('User changed type of a price', 'wp-security-audit-log'), __('Changed the %PriceType% price of the product %ProductTitle% from %OldPrice% to %NewPrice%. View the product: %EditorLinkProduct%.', 'wp-security-audit-log')),
            ...
            array(9026, E_WARNING, __('User changed the URL of the Downloadable File in a product', 'wp-security-audit-log'), __('Changed the URL of the Downloadable File %FileName% from %OldUrl% to %NewUrl% in product %product%. View the product: %EditorLinkProduct%.', 'wp-security-audit-log')),
