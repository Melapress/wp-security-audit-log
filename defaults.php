			...
			array(
				...
				__( 'Third Party Plugins', 'wp-security-audit-log' ) => array(
					...
					__( 'WooCommerce Products', 'wp-security-audit-log' ) => array(
						...
						array( 9020, E_WARNING, __( 'User set a product type', 'wp-security-audit-log' ), __( 'Changed the type of the %ProductStatus% product %ProductTitle% from %OldType% to %NewType%. View the product: %EditorLinkProduct%.', 'wp-security-audit-log' ) ),
					...
					__( 'WooCommerce', 'wp-security-audit-log' ) => array(
						...
						array( 9035, E_NOTICE, __( 'A WooCommerce order has been placed', 'wp-security-audit-log' ), __( 'A WooCommerce order %OrderTitle% has just been placed.', 'wp-security-audit-log' ) ),
						array( 9036, E_NOTICE, __( 'WooCommerce order status changed', 'wp-security-audit-log' ), __( 'Marked the WooCommerce order %OrderTitle% as %OrderStatus%', 'wp-security-audit-log' ) ),
						...
						array( 9038, E_WARNING, __( 'User moved a WooCommerce order out of trash', 'wp-security-audit-log' ), __( 'Moved the WooCommerce order %OrderTitle% out of trash.', 'wp-security-audit-log' ) ),
						...
						array( 9040, E_NOTICE, __( 'User edited a WooCommerce order', 'wp-security-audit-log' ), __( 'Edited the WooCommerce order %OrderTitle%.', 'wp-security-audit-log' ) ),
						array( 9041, E_WARNING, __( 'User refunded a WooCommerce order', 'wp-security-audit-log' ), __( 'Refunded the WooCommerce order %OrderTitle%.', 'wp-security-audit-log' ) ),
					),
