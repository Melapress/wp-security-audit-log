...
WpSecurityAuditLog::GetInstance()
	->alerts->RegisterGroup(array(
		...
		'Blog Posts' => array(
			...
			array(2019, E_NOTICE, 'User changed blog post author', ''),
			...
			array(2027, E_NOTICE, 'User changed the date of a blog post', ''),
		...
		'Custom Posts' => array(
			...
			array(2038, E_NOTICE, 'User changed the author or post with custom post type', ''),
		...
		'System Activity' => array(
			...
			array(6001, E_ERROR, 'Option Anyone Can Register in WordPress settings changed', 'Wordpress setting "Anyone Can Register" changed to %NewValue%.'),
			array(6002, E_ERROR, 'New User Default Role changed', 'Default role for new users changed to %NewRole%.'),
			array(6003, E_ERROR, 'WordPress Administrator Notification email changed', 'Wordpress administrator email changed to %NewEmail%.'),
		...
		'MultiSite' => array(
			...
			array(7000, E_ERROR, 'New site added on network', ''),
			array(7001, E_ERROR, 'Existing site archived', ''),
			array(7002, E_ERROR, 'Archived site has been unarchived', ''),
			array(7003, E_ERROR, 'Deactivated site has been activated', ''),
			array(7004, E_ERROR, 'Site has been deactivated', ''),
			array(7005, E_ERROR, 'Existing site deleted from network', ''),
		),
	));
