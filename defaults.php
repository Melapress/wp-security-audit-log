...
function wsaldefaults_wsal_init(WpSecurityAuditLog $wsal)
{
    ...
    $wsal->alerts->RegisterGroup(array(
            ...
            __('Comments', 'wp-security-audit-log') => array(
                ...
                array(2093, E_NOTICE, __('User edited a comment', 'wp-security-audit-log'), __('Edited a comment posted in response to the post %PostTitle% by %Author% on %Date%.', 'wp-security-audit-log')),
                ...
                array(2095, E_NOTICE, __('User marked a comment as Not Spam', 'wp-security-audit-log'), __('Marked the comment posted in response to the post %PostTitle% by %Author% on %Date% as Not Spam.', 'wp-security-audit-log')),
                ...
                array(2099, E_NOTICE, __('User posted a comment', 'wp-security-audit-log'), __('Posted a comment in response to the post %PostTitle% by %Author% on <a href="%CommentLink%">%Date%</a>.', 'wp-security-audit-log'))
            ),
