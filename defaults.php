...
function wsaldefaults_wsal_init(WpSecurityAuditLog $wsal)
{
    ...
    $wsal->alerts->RegisterGroup(array(
            ...
            __('Blog Posts', 'wp-security-audit-log') => array(
                ...
                array(2065, E_WARNING, __('User modifies content for a published post', 'wp-security-audit-log'), __('Modified the content of the published post %PostTitle%.'.'%RevisionLink%', 'wp-security-audit-log')),
                array(2068, E_NOTICE, __('User modifies content for a draft post', 'wp-security-audit-log'), __('Modified the content of the draft post %PostTitle%.'.'%RevisionLink%', 'wp-security-audit-log')),
