		...
		array(
			__( 'Content & Comments', 'wp-security-audit-log' ) => array(
				__( 'Blog Posts', 'wp-security-audit-log' ) => array(
					...
					array( 2119, E_NOTICE, __( 'User added blog post tag', 'wp-security-audit-log' ), __( 'Added the tag %tag% on the %1$status% post %post_title%. View the post: %2$EditorLinkPost%.', 'wp-security-audit-log' ) ),
					array( 2120, E_NOTICE, __( 'User removed blog post tag', 'wp-security-audit-log' ), __( 'Removed the tag %tag% on the %1$status% post %post_title%. View the post: %2$EditorLinkPost%.', 'wp-security-audit-log' ) ),
			...
			__( 'Users Profiles & Activity', 'wp-security-audit-log' ) => array(
				...
				__( 'User Profiles', 'wp-security-audit-log' ) => array(
					...
					array( 4015, E_NOTICE, __( 'User updated a custom field value for a user', 'wp-security-audit-log' ), __( 'Changed the value of the custom field %1$custom_field_name% from %2$old_value% to %new_value% for the user %TargetUsername%.', 'wp-security-audit-log' ) ),
