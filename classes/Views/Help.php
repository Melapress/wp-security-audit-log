	...
	public function tab_help() {
		...
		<div class="wsal-help-section">
			...
			<p>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a class="button" href="https://wpactivitylog.com/support-documentation/?utm_source=plugin&utm_medium=referral&utm_campaign=WSAL&utm_content=knowledge+base" target="_blank"><?php esc_html_e( 'Knowledge Base', 'wp-security-audit-log' ); ?></a>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a class="button" href="https://wpactivitylog.com/support-documentation/list-wordpress-audit-trail-alerts/?utm_source=plugin&utm_medium=referral&utm_campaign=WSAL&utm_content=list+events" target="_blank"><?php esc_html_e( 'List of activity logs event IDs', 'wp-security-audit-log' ); ?></a>
			</p>
		</div>
		<div class="wsal-help-section">
