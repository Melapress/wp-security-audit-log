			...
			<div class="postbox" style="margin-right: 270px;">
				...
				<div class="inside">
					<div class="activity-block">
						...
						<p>
							<img src="<?php echo $this->_plugin->GetBaseUrl(); ?>/img/logo-about-wsal.png" alt="" style="float: left; margin: 0 10px 10px 0;" width="156" height="130"/>
						...
						<ul>
							...
							<li>and much more&hellip;<br/>&nbsp;</li>
							<li>Refer to the complete list of <a href="http://www.wpwhitesecurity.com/wordpress-security-plugins/wp-security-audit-log/security-audit-alerts-logs/?utm_source=wpsalabt&utm_medium=txtlink&utm_campaign=wpsal" target="_blank">WordPress Security Alerts</a> for more information.</li>
						</ul>
					</div>
				</div>
			</div>
