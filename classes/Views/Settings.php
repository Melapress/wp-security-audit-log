...
class WSAL_Views_Settings extends WSAL_AbstractView {
	...
	private function tab_general() {
		...
		<p class="description">
			...
			echo sprintf(
				...
				'<a href="https://wpactivitylog.com/support-documentation/support-reverse-proxies-web-application-firewalls/?utm_source=plugin&utm_medium=referral&utm_campaign=WSAL&utm_content=settings+pages" target="_blank">' . esc_html__( 'learn more', 'wp-security-audit-log' ) . '</a>'
			);
			?>
		</p>
		<table class="form-table wsal-tab">
		...
		echo wp_kses(
			sprintf(
				...
				'<a href="https://wpactivitylog.com/support-documentation/managing-wordpress-activity-log-plugin-privileges/?utm_source=plugin&utm_medium=referral&utm_campaign=WSAL&utm_content=settings+pages" target="_blank">' . __( 'learn more', 'wp-security-audit-log' ) . '</a>'
			),
			$allowed_tags
		);
		?>
		...
		echo wp_kses(
			sprintf(
				...
				'<a href="https://wpactivitylog.com/support-documentation/can-allow-users-access-audit-trail/?utm_source=plugin&utm_medium=referral&utm_campaign=WSAL&utm_content=settings+pages" target="_blank">' . __( 'learn more', 'wp-security-audit-log' ) . '</a>'
			),
			$allowed_tags
		);
		?>
	...
	private function tab_file_changes() {
		...
		<p class="description">
			...
			<?php echo wp_kses( __( '<a href="https://wpactivitylog.com/support-documentation/wordpress-files-changes-warning-activity-logs/?utm_source=plugin&utm_medium=referral&utm_campaign=WSAL&utm_content=settings+pages" target="_blank">Refer to the WordPress file integrity scans feature page</a> for more information.', 'wp-security-audit-log' ), $this->_plugin->allowed_html_tags ); ?>
		</p>
