	...
	(0, _jquery2.default)('#editor-users-add, #editor-roles-add, #exuser-query-add, #exrole-query-add, #ipaddr-query-add').click(function () {
		...
		_jquery2.default.ajax({
			...
			success: function success(data) {
				...
				(0, _jquery2.default)('#' + type + '-list').append((0, _jquery2.default)('<span class="sectoken-' + data + '"/>').text(tokenValue).append((0, _jquery2.default)('<input type="hidden" name="' + type + 's[]"/>').val(tokenValue), (0, _jquery2.default)('<a href="javascript:;" title="Remove">&times;</a>').click(removeSecToken)));
			},
